...
void RS485_9bitModeMaster()
{
    ...
    UART_SelectRS485Mode(UART0, UART_ALTCTL_RS485_AUD_Msk, 0);
...
void RS485_9bitModeSlave()
{
    ...
    /* Set RS485-NMM Mode */
    UART_SelectRS485Mode(UART0, UART_ALTCTL_RS485_NMM_Msk|UART_ALTCTL_ADDRDEN_Msk, 0);
    ...
    UART_SelectRS485Mode(UART0, UART_ALTCTL_RS485_AAD_Msk|UART_ALTCTL_ADDRDEN_Msk|UART_ALTCTL_RS485_AUD_Msk, MATCH_ADDRSS1);
#endif
