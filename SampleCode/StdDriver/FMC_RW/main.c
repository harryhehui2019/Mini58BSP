...
void run_crc32_checksum()
{
    ...
    if (FMC_GetCRC32Sum(FMC_SPROM_BASE, FMC_SPROM_SIZE, &chksum) == 0)
        printf("  SPROM CRC32 checksum .................. [0x%08x]\n", chksum);
    else
        printf("  SPROM CRC32 checksum .................. ERROR!!\n");
}
...
int main()
{
    ...
    if (flash_test(FMC_SPROM_BASE, FMC_SPROM_END - 4, TEST_PATTERN) < 0)
    {
        printf("\n\nSPROM test failed!\n");
        goto lexit;
    }
