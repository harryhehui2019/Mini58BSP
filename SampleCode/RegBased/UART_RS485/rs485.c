...
void RS485_9bitModeMaster()
{
    ...
    UART0->FUNSEL = (0x3 << UART_FUNSEL_FUN_SEL_Pos);
    UART0->ALTCTL = UART_ALTCTL_RS485_AUD_Msk;   /* Enable AUD to HW control RTS pin automatically */
...
void RS485_9bitModeSlave()
{
    ...
    /* Set RS485-NMM Mode */
    UART0->ALTCTL = UART_ALTCTL_RS485_NMM_Msk |
    ...
    UART->ALTCTL = UART_ALTCTL_RS485_AAD_Msk |
    ...
    /* Set UART Function */
    UART0->FUNSEL = (0x0 << UART_FUNSEL_FUN_SEL_Pos);
    printf("\n\nEnd test\n");
}
